...
with open('releases.json', 'r', encoding='utf-8') as file:
    data = json.load(file)
...
excel_files = ['data1.xlsx', 'data2.xlsx', 'data3.xlsx', 'data4.xlsx']
...
def filter_data(df, track_info):
    filtered_rows = []

    for upc, release_date in track_info:
